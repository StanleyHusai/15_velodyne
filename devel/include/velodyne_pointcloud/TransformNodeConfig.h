...
//#line 293 "/opt/ros/jade/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(TransformNodeConfig::AbstractParamDescriptionConstPtr(new TransformNodeConfig::ParamDescription<std::string>("frame_id", "str", 0, "new frame of reference for point clouds", "", &TransformNodeConfig::frame_id)));
//#line 293 "/opt/ros/jade/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(TransformNodeConfig::AbstractParamDescriptionConstPtr(new TransformNodeConfig::ParamDescription<std::string>("frame_id", "str", 0, "new frame of reference for point clouds", "", &TransformNodeConfig::frame_id)));
