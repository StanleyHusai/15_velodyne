...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_driver_SOURCE_PREFIX /home/husai/15_velodyne/src/velodyne/velodyne_driver)
  set(velodyne_driver_DEVEL_PREFIX /home/husai/15_velodyne/devel)
  ...
  set(velodyne_driver_INSTALL_PREFIX /home/husai/15_velodyne/install)
...
if(NOT "/home/husai/15_velodyne/devel/include;/home/husai/15_velodyne/src/velodyne/velodyne_driver/include " STREQUAL " ")
  set(velodyne_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/husai/15_velodyne/devel/include;/home/husai/15_velodyne/src/velodyne/velodyne_driver/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'velodyne_driver' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Jack O'Quin <jack.oquin@gmail.com>, Brice Rebsamen <brice.rebsamen@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'velodyne_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/husai/15_velodyne/src/velodyne/velodyne_driver/${idir}'.  Ask the maintainer 'Jack O'Quin <jack.oquin@gmail.com>, Brice Rebsamen <brice.rebsamen@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${velodyne_driver_dep}_FOUND)
      find_package(${velodyne_driver_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${velodyne_driver_dep} REQUIRED ${depend_list})
  endif()
